...
export function HeroSection() {
  ...
  return (
    <section ref={rootRef} className="relative w-full overflow-hidden bg-white">
      <video
        ...
        <div className="flex w-full flex-col items-start gap-8 lg:flex-row lg:items-end lg:gap-[15.28%]">
          ...
          <div className="flex w-full min-w-0 flex-col gap-5 lg:w-[48.33%] lg:gap-[72px]">
            ...
            <div className="flex flex-col gap-5 lg:gap-6">
              <h1 data-hero-anim data-hero-title className="text-[20px] leading-[28px] font-semibold tracking-[0.01em] text-neo-ink md:text-[36px] md:leading-[46px] lg:text-[64px] lg:leading-[80px] lg:tracking-[0]">
                Biznesinizi Gələcəyin{" "}
                <span className="text-neo-teal">Rəqəmsal</span> Həlləri ilə
                Gücləndiririk
              </h1>
              <p data-hero-anim className="text-[12px] leading-[16px] font-normal tracking-[0.01em] text-neo-muted md:text-[16px] md:leading-[24px] lg:text-[20px] lg:leading-[28px]">
            ...
            <div data-hero-anim className="flex gap-5">
              <MagneticLink
                href="/contact"
