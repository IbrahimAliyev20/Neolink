...
export function FeaturedPost({ post }: { post: BlogPost }) {
  return (
    <ClipReveal className="w-full shrink-0 lg:w-[710px]">
      <Link
        href={`/blogs/${post.slug}`}
        className="group/featured border border-[#f2f4f8] h-[213px] relative rounded-[14px] w-full lg:h-[440px] lg:rounded-2xl overflow-hidden block"
      >
