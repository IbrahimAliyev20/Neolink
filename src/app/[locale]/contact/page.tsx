  ...
  return (
    <>
      <div className="relative w-full bg-[#f7f7f7]">
        <div className="absolute inset-0 bg-[#0d153a] lg:bottom-auto lg:h-[660px] lg:rounded-bl-[120px]" />
                ...
                {contactInfo.map((item) => (
                  <div key={item.label} className="flex gap-4 items-start">
                    ...
                    <div className="flex flex-col gap-1 items-start">
                      ...
                      {item.lines.map((line) => (
                        <p key={line} className="font-medium text-white text-base leading-6 whitespace-nowrap">
                          {line}
                        </p>
                      ))}
                    </div>
